...
import fr.nextdigital.lab.warehouse.web.order.domain.LineItem;
...
public class WarehouseService extends Service<Warehouse, Long> {
    ...
    public Warehouse update(Warehouse warehouse) {
        ...
        Assert.state(warehouseRepository.existsById(warehouse.getIdentity()),
    ...
    public boolean delete(Long id) {
        Assert.state(warehouseRepository.existsById(id),
                "The warehouse with the supplied id does not exist");
