package fr.nextdigital.lab.warehouse.worker.warehouse.config;
...
import fr.nextdigital.lab.warehouse.worker.warehouse.event.WarehouseEventProcessor;
...
import fr.nextdigital.lab.warehouse.worker.warehouse.function.WarehouseCreated;
import fr.nextdigital.lab.warehouse.worker.warehouse.function.WarehouseFunction;
...
public class WarehouseStateMachineConfig extends EnumStateMachineConfigurerAdapter<WarehouseStatus, WarehouseEventType> {
    ...
    final private Logger log = org.slf4j.LoggerFactory.getLogger(WarehouseStateMachineConfig.class);
