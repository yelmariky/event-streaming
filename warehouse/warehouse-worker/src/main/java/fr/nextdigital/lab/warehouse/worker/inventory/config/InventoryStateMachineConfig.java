package fr.nextdigital.lab.warehouse.worker.inventory.config;
...
import fr.nextdigital.lab.warehouse.worker.inventory.event.InventoryEventProcessor;
...
import fr.nextdigital.lab.warehouse.worker.inventory.function.*;
...
public class InventoryStateMachineConfig extends EnumStateMachineConfigurerAdapter<InventoryStatus,
    ...
    final private Logger log = LoggerFactory.getLogger(InventoryStateMachineConfig.class);
