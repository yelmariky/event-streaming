package fr.nextdigital.lab.warehouse.worker.reservation.config;
...
import fr.nextdigital.lab.warehouse.worker.reservation.event.ReservationEventProcessor;
...
import fr.nextdigital.lab.warehouse.worker.reservation.function.*;
...
import static fr.nextdigital.lab.warehouse.worker.order.domain.OrderStatus.ORDER_FAILED;
import static fr.nextdigital.lab.warehouse.worker.order.domain.OrderStatus.RESERVATION_FAILED;
import static fr.nextdigital.lab.warehouse.worker.order.domain.OrderStatus.RESERVATION_PENDING;
...
public class ReservationStateMachineConfig extends EnumStateMachineConfigurerAdapter<ReservationStatus,
    ...
    final private Logger log = LoggerFactory.getLogger(ReservationStateMachineConfig.class);
